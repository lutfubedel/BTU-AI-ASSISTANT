...
RAPOR_DOSYASI = "test_raporu_guncel.txt"
...
def metin_normalize_et(metin):
    ...
    Nokta, virgül ve İKİ NOKTA ÜST ÜSTE gibi işaretleri temizler.
    Böylece '12:00' ile '12.00' veya '12558' ile '12.558' mükemmel eşleşir.
    """
...
def run_performance_test():
    ...
    for i, data in enumerate(TEST_DATA, 1):
        ...
        try:
            response = requests.post(API_URL, json={"message": soru}, timeout=60)
